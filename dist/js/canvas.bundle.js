...
Star.prototype.update = function () {
  ...
  //When the stars reach the bottom of the screen, they bounce back up
...
function MiniStar(x, y, radius, color) {
  ...
  this.velocity = {
    x: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(-3, 3),
...
function animate() {
  ...
  if (ticker % randomSpawnRate == 0) {
    ...
    randomSpawnRate = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(75, 200);
  }
}
init();
animate();
